...
@Autonomous(name = "AutoRotoTraslazionev6", group = "Autonomous")
public class AutoRotoTraslazionev6 extends LinearOpMode {
  ...
  double Kp = 0; //0.5318442383620181;;
  double Ki = 0; //2; //2.253450776719937;
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      ...
      moto_temporale(0, 5, 0, 0, p);
      moto_temporale(-1, 5, 0, 0, 0);
      
      nomefile = String.valueOf(Kp) + "_" + String.valueOf(Ki) + "_" + String.valueOf(Kd) + "_" + String.valueOf(Math.toDegrees(phi)) + "_PID.txt";
      //nomefile = String.valueOf(Kp) + "_" + String.valueOf(Ki) + "_" + String.valueOf(Kd) + "_PID.txt";
    }
  ...
  private void moto_temporale(int moto, double t, double x, double y, double alpha) {
    ...
    while(opModeIsActive() && timer.seconds() <= t){
      ...
      switch (moto){
        ...
        case 0:  P = rotazione(alpha); break; //"Rotazione";
